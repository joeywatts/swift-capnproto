...
Both fuzz entry points therefore consume all eight committed binaries under
...
`Scripts/verify-fuzz-targets.sh` runs every upstream-derived seed through both
